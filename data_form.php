    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <?php if ($_GET['form'] == "add") {
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="stok_sistem" id="inputError">
                    </div>

                    <div class="form-group">
                        <label class="control-label" for="inputError">Input Stok Lapangan</label>
                        <input type="number" class="form-control" name="stok_lap" id="inputError">
                    </div>
            ...
            <?php } else if ($_GET['form'] == "edit") {
                ...
                $query = mysqli_query($kon, "SELECT * FROM dataset WHERE iddata='$_GET[id]'");
                $data = mysqli_fetch_assoc($query);
                $kode = $data['kode'];
                $nama = $data['nama'];
                $stok_sistem = $data['stok_sistem'];
                $stok_lap = $data['stok_lap'];
            ...
            ?>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="inputError">Input Stok Dalam Sistem</label>
                        <input type="number" class="form-control" name="stok_sistem" id="inputError" value="<?= $stok_sistem ?>">
                    </div>

                    <div class="form-group">
                        <label class="control-label" for="inputError">Input Stok Lapangan</label>
                        <input type="number" class="form-control" name="stok_lap" id="inputError" value="<?= $stok_lap ?>">
                    </div>

                    <div class="form-group">
                        <label class="control-label" for="inputError">Tanggal</label>
                        <input type="date" class="form-control" name="tanggal" id="inputError" value="<?= $tanggal ?>">
                    </div>
